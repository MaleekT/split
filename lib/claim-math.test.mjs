...
import { computeClaimPlan, claimTransferCount, claimReserveRaw, transactionFeeReserveRaw, isDustAmount } from './claim-math.ts'
...
test('transactionFeeReserveRaw rounds upward at the USDC precision boundary', () => {
  assert.equal(transactionFeeReserveRaw(1n, 1n), 1n)
  assert.equal(transactionFeeReserveRaw(90_000n, 20_000_000_000n), 1_800n)
})
